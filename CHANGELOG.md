...
[All Commits](https://github.com/wardenenv/warden/compare/0.13.1..develop)
...
## Version [0.12.0](https://github.com/wardenenv/warden/tree/0.12.0) (2021-08-28)
[All Commits](https://github.com/wardenenv/warden/compare/0.11.0..0.12.0)

**Enhancements:**

* Added Elastic HQ support available at elastichq.mydomain.test for viewing Elasticsearch data ([#350](https://github.com/wardenenv/warden/pull/350) by @Den4ik)
* Update selenium to standalone latest version resolving issues with old hub/chrome image combinations ([#349](https://github.com/wardenenv/warden/pull/349) by @Den4ik)
* Environment and image build improvements ([#363](https://github.com/wardenenv/warden/pull/363) by @Den4ik)
* Introduces new redis sub-command for easy access to the running redis container ([#413](https://github.com/wardenenv/warden/pull/413) by @werfu)
* SSH known hosts will now be persisted via an additional `sshdirectory:/home/www-data/.ssh` volume on php-fpm containers ([#315](https://github.com/wardenenv/warden/pull/315) by @ihor-sviziev)
* Docker images for Nginx 1.18 are now available ([#414](https://github.com/wardenenv/warden/pull/414) by @darrakurt)

**Bug Fixes:**

* Fixed loadEnvConfig inability to parse .env with CRLF line endings (issue [#380](https://github.com/wardenenv/warden/issues/380))

## Version [0.11.0](https://github.com/wardenenv/warden/tree/0.11.0) (2021-04-22)
[All Commits](https://github.com/wardenenv/warden/compare/0.10.2..0.11.0)
...
For full details on what went into these rebuilds, please see [#345](https://github.com/wardenenv/warden/pull/345).

Huge shout out to @tdgroot who helped with updating the builds, testing, etc.

**Enhancements:**

* Shopware and Symfony environments will now use Composer v2 by default (issue [#359](https://github.com/wardenenv/warden/issues/359))

## Version [0.10.2](https://github.com/wardenenv/warden/tree/0.10.2) (2021-04-03)
[All Commits](https://github.com/wardenenv/warden/compare/0.10.1..0.10.2)

**Bug Fixes:**

* Fixed bug where Live Reload might not work when Varnish was disabled due to routing priorities ([#337](https://github.com/wardenenv/warden/pull/337) by @alinalexandru)

**Enhancements:**

* Magento 1 and Magento 2 environments now set developer environment variables by default ([#332](https://github.com/wardenenv/warden/pull/332) by @norgeindian)
* SSH Agent forwarding will no longer use socat except when needed ([#334](https://github.com/wardenenv/warden/pull/334) by @alinalexandru)

## Version [0.10.1](https://github.com/wardenenv/warden/tree/0.10.1) (2021-03-01)
[All Commits](https://github.com/wardenenv/warden/compare/0.10.0..0.10.1)

**Bug Fixes:**

* Fixed a bug where SSH Agent forwarding would break following container restart ([#307](https://github.com/wardenenv/warden/pull/307) by @ihor-sviziev)
* Fixed a issue where Xdebug 3 images would generate excessive profile data when running CLI commands in debug container ([#309](https://github.com/wardenenv/warden/pull/309) by @Den4ik)
...
* There is now a `warden db dump` command available to run `mysqldump` on the `db` container ([#310](https://github.com/wardenenv/warden/pull/310) by @Den4ik)
* Bash history will now be persisted via an additional `bashhistory:/bash_history` volume on php-fpm containers ([#304](https://github.com/wardenenv/warden/pull/304) by @Den4ik)

## Version [0.10.0](https://github.com/wardenenv/warden/tree/0.10.0) (2021-02-13)
[All Commits](https://github.com/wardenenv/warden/compare/0.9.1..0.10.0)
...
* Warden now requires `mutagen` 0.11.8 or later for environments leveraging sync sessions on Mac OS. Reference issue [#235](https://github.com/wardenenv/warden/issues/235) for details. This is to resolve an incompatibility between earlier versions of Mutagen and Docker Desktop 2.3.0.5 and later.
...
* The `.idea` directory is no longer ignored from Mutagen sync allowing `bin/magento dev:urn-catalog:generate` to be generate metadata the IDE uses (issue [#291](https://github.com/wardenenv/warden/issues/291))
* Installing on WSL will no longer report innocuous errors related to lack of systemd support on WSL as the install routine no longer makes calls to `systemctl` on Linux systems (issue [#220](https://github.com/wardenenv/warden/issues/220))

**Enhancements:**

* Added opt-in support for Xdebug 3 (see docs for details; new environments will set `PHP_XDEBUG_3=1`) ([#279](https://github.com/wardenenv/warden/pull/279) by @Den4ik)
* Added ability to provide persistent additional configuration to `dnsmasq` service (issue [#214](https://github.com/wardenenv/warden/issues/214))
* Added ability to easily specify alternate nameservers for `dnsmasq` to use (issue [#214](https://github.com/wardenenv/warden/issues/214))
* Added ability to customize bundled environment compositions by overriding them in the Warden home dir ([#228](https://github.com/wardenenv/warden/pull/228) by @k4emic)
* Added ability to override sync configuration on a per-project basis or provide one on env types such as `local` where default one does not exist ([#246](https://github.com/wardenenv/warden/pull/246) by @Den4ik)
* Updated version of Portainer from 1.24.X to 2.0.X ([#245](https://github.com/wardenenv/warden/pull/245) by @MarcoFaul)
* Added support for `COMPOSER_VERSION` in `.env` to configure `composer` to run the newer Composer v2. At this time the default remains Composer v1 for compatibility reasons (issue [#296](https://github.com/wardenenv/warden/issues/296))
* Added modman support for `magento1` environment type ([#290](https://github.com/wardenenv/warden/pull/290) by @norgeindian)

## Version [0.9.1](https://github.com/wardenenv/warden/tree/0.9.1) (2020-08-25)
[All Commits](https://github.com/wardenenv/warden/compare/0.9.0..0.9.1)

**Bug Fixes:**

* Fixed bug on WSL2 where Xdebug connect back host was improperly set ([#213](https://github.com/wardenenv/warden/pull/213) by @ihor-sviziev)

## Version [0.9.0](https://github.com/wardenenv/warden/tree/0.9.0) (2020-08-06)
[All Commits](https://github.com/wardenenv/warden/compare/0.8.2..0.9.0)

**Upgrade Notes:**

* Removed deprecated first-class commands `warden start`, `warden stop`, `warden up`, `warden down`, and `warden restart`; please use `warden svc <verb>` to manage global services such as Traefik, Portainer, Mailhog, etc ([#205](https://github.com/wardenenv/warden/pull/205) by @davidalger)

**Enhancements:**

* Added a new `wordpress` environment type pre-configured for running the Wordpress application ([#206](https://github.com/wardenenv/warden/pull/206) by @jamescowie)

## Version [0.8.2](https://github.com/wardenenv/warden/tree/0.8.2) (2020-08-03)
[All Commits](https://github.com/wardenenv/warden/compare/0.8.1..0.8.2)

**Enhancements:**

* Changed all `:delegated` mounts to `:cached` mounts to preserve existing behavior of mounts when new behavior in Docker Desktop Edge 2.3.2.0 is promoted to stable channel ([#204](https://github.com/wardenenv/warden/pull/204) by @davidalger)

## Version [0.8.1](https://github.com/wardenenv/warden/tree/0.8.1) (2020-07-30)
[All Commits](https://github.com/wardenenv/warden/compare/0.8.0..0.8.1)
...
* Fixed issue where nginx would unexpectedly exit on Linux due to incorrect default value for `XDEBUG_CONNECT_BACK_HOST` in base nginx configuration (issue [#200](https://github.com/wardenenv/warden/issues/200))

## Version [0.8.0](https://github.com/wardenenv/warden/tree/0.8.0) (2020-07-27)
[All Commits](https://github.com/wardenenv/warden/compare/0.7.0..0.8.0)
...
* Added `warden vnc` command to launch VNC tunnel via SSH or (when installed) launch Remmina ([#116](https://github.com/wardenenv/warden/pull/116) by @lbajsarowicz)
...
* Updated `warden debug` to also pass `host.docker.internal` into the `php-debug` container for the `XDEBUG_REMOTE_HOST` value on WSL when Microsoft is present in `/proc/sys/kernel/osrelease` ([#196](https://github.com/wardenenv/warden/pull/196) by @LeeSaferite)
* Updated nginx configuration to pass `XDEBUG_CONNECT_BACK_HOST` as environment variable in base config allowing it to be overridden by exported env variable on all host OS envs ([#199](https://github.com/wardenenv/warden/pull/199) by @LeeSaferite)

## Version [0.7.0](https://github.com/wardenenv/warden/tree/0.7.0) (2020-07-22)
[All Commits](https://github.com/wardenenv/warden/compare/0.6.0..0.7.0)

**Upgrade Notes:**

* With `mailhog` being changed from running on a per-project basis to running as a global service (see issue [#175](https://github.com/wardenenv/warden/issues/175)) you will need to ensure `warden svc up` has been run after updating Warden. On pre-existing projects that already had their own Mailhog container running, `warden env up --remove-orphans` will clean it up.

**Enhancements:**

* Added `warden blackfire` command for easily running profiles via the CLI tool ([#188](https://github.com/wardenenv/warden/pull/188) by @navarr)
* Changed `mailhog` service to run as a single global service rather than as a per-project service (issue [#175](https://github.com/wardenenv/warden/issues/175))
* Updated `warden db import` to strip usages of `@@GLOBAL.GITD_PURGED` and `@@SESSION.SQL_LOG_BIN` from database dumps during import process to avoid failures importing databases originating from Amazon RDS (issue [#162](https://github.com/wardenenv/warden/issues/162))
* Added Mutagen sync configuration for `magento1` environment type (issue [#97](https://github.com/wardenenv/warden/issues/97))

## Version [0.6.0](https://github.com/wardenenv/warden/tree/0.6.0) (2020-07-02)
[All Commits](https://github.com/wardenenv/warden/compare/0.5.3..0.6.0)

**Upgrade Notes:**

* Warden now requires `docker-compose` 1.25.0 or later; see [issue #165](https://github.com/wardenenv/warden/issues/165)
...
* Updated `warden env-init` command to prompt user before overwriting an existing `.env` file in a project directory ([#166](https://github.com/wardenenv/warden/pull/166) by @Lunaetic)
* Updated `warden env-init` command to prompt user for required arguments when missing ([#170](https://github.com/wardenenv/warden/pull/170) by @Lunaetic)
* Added support for Magepack advanced JS bundling ([#138](https://github.com/wardenenv/warden/pull/138) by @vbuck)
* Added a new `shopware` environment type including Mutagen configuration for file sync on macOS (issue [#169](https://github.com/wardenenv/warden/issues/169))
* Added support for implementing custom commands in `~/.warden/commands` or `<project>/.warden/commands` ([#172](https://github.com/wardenenv/warden/pull/172) by @davidalger)
...
* Added ability to pass arguments to and override the database name `db connect` and `db import` operate on (issue [#22](https://github.com/wardenenv/warden/issues/22))
...
## Version [0.5.3](https://github.com/wardenenv/warden/tree/0.5.3) (2020-06-23)
[All Commits](https://github.com/wardenenv/warden/compare/0.5.2..0.5.3)

**Bug Fixes:**

* Reverted filtering of GTID SET commands as added in 0.5.2 release to resolve db import errors (issue [#162](https://github.com/wardenenv/warden/issues/162))

## Version [0.5.2](https://github.com/wardenenv/warden/tree/0.5.2) (2020-06-11)
[All Commits](https://github.com/wardenenv/warden/compare/0.5.1..0.5.2)

**Enhancements:**

* Fixed inability to run `warden debug -c '<command>'` in like manner to `warden shell -c ...`
* Fixed issue where GTID related SET statements in a database dump failed the import (issue [#162](https://github.com/wardenenv/warden/issues/162))

## Version [0.5.1](https://github.com/wardenenv/warden/tree/0.5.1) (2020-05-28)
[All Commits](https://github.com/wardenenv/warden/compare/0.5.0..0.5.1)
...
## Version [0.5.0](https://github.com/wardenenv/warden/tree/0.5.0) (2020-05-21)
[All Commits](https://github.com/wardenenv/warden/compare/0.4.4..0.5.0)
...
* Added `symfony` environment type for use with Symfony 4+ ([#146](https://github.com/wardenenv/warden/pull/146) by @lbajsarowicz)
* Added `COMPOSER_MEMORY_LIMIT=-1` to env on all `php-*` containers ([#154](https://github.com/wardenenv/warden/pull/154) by @navarr)
...
## Version [0.4.4](https://github.com/wardenenv/warden/tree/0.4.4) (2020-05-14)
[All Commits](https://github.com/wardenenv/warden/compare/0.4.3..0.4.4)
...
* Fixed lack of `extra_hosts` in `php-blackfire` and `blackfire-agent` containers (issue [#145](https://github.com/wardenenv/warden/issues/145))
* Fixed missing `extra_hosts` line for non-subdomain entry in `/etc/hosts` on `selenium` container
* Fixed `$OSTYPE` check for compatibility with OpenSUSE which uses `linux` rather than `linux-gnu` ([#149](https://github.com/wardenenv/warden/pull/149) by @Den4ik)

## Version [0.4.3](https://github.com/wardenenv/warden/tree/0.4.3) (2020-05-02)
[All Commits](https://github.com/wardenenv/warden/compare/0.4.2..0.4.3)
...
## Version [0.4.2](https://github.com/wardenenv/warden/tree/0.4.2) (2020-04-15)
[All Commits](https://github.com/wardenenv/warden/compare/0.4.1..0.4.2)

**Enhancements:**

* Added `WARDEN_SYNC_IGNORE` to support passing a comma-separated list of additional [per-session-ignores](https://mutagen.io/documentation/synchronization/ignores#per-session-ignores) to Mutagen when sync sessions are started ([#142](https://github.com/wardenenv/warden/pull/142) by @davidalger)
* Added pause, resume and monitor to `warden sync` command ([#141](https://github.com/wardenenv/warden/pull/141) by @fooman)
* Changed Mutagen sync to pause on `warden env stop` and resume on `warden env up -d` ([#141](https://github.com/wardenenv/warden/pull/141) by @fooman)

**Bug Fixes:**

* Removed exclusion of (commonly large) files types (*.sql, *.gz, *.zip, *.bz2) from sync sessions (as introduced in 0.4.0) because it broke the ability to use artifact repositories with composer ([#142](https://github.com/wardenenv/warden/pull/142) by @davidalger)

## Version [0.4.1](https://github.com/wardenenv/warden/tree/0.4.1) (2020-04-11)
[All Commits](https://github.com/wardenenv/warden/compare/0.4.0..0.4.1)

**Bug Fixes:**

* Removed `tmpfs` volumes from sub-directories of `/var/www/html` when `WARDEN_TEST_DB=1` was set due to compatibility issues ([#139](https://github.com/wardenenv/warden/pull/139) by @lbajsarowicz)

## Version [0.4.0](https://github.com/wardenenv/warden/tree/0.4.0) (2020-04-02)
[All Commits](https://github.com/wardenenv/warden/compare/0.3.1..0.4.0)

**Upgrade Notes:**

The introduction of SSH Agent Forwarding support in [PR #121](https://github.com/wardenenv/warden/pull/121) results in Warden now requiring Docker Desktop 2.2.0.0 or later for macOS clients. Please upgrade Docker Desktop prior to upgrading to the latest Warden release to avoid errors relating to unauthorized mounts.

**Enhancements:**

* Added MySQL 5.6 and 5.7 images to Quay repository for use with Warden environments
* Added support for Integration, Unit and API Tests leveraging a `MySQL 5.7` container running on `tempfs` memory disk ([#115](https://github.com/wardenenv/warden/pull/115) by @lbajsarowicz)
* Added `WARDEN_ALLURE` setting to control Allure separately from Selenium for use reporting on Integration and Unit tests ([#117](https://github.com/wardenenv/warden/pull/117) by @lbajsarowicz)
* Added ssh agent forwarding support on both macOS and Linux hosts ([#121](https://github.com/wardenenv/warden/pull/121) by @davidalger)
* Updated entrypoint in php-fpm images to support mounting PEM files into `/etc/pki/ca-trust/source/anchors` ([3a841b7d](https://github.com/wardenenv/warden/commit/3a841b7dd80c6827bc8bf238ae8ff53b2519a258))
...
* Fixed race condition caused by docker-compose starting two containers with identical mounts simultaneously (issue [#110](https://github.com/wardenenv/warden/issues/110))
* Fixed issue with incorrect network name reference when uppercase characters are present in `WARDEN_ENV_NAME` (issue [#127](https://github.com/wardenenv/warden/issues/127))
...
## Version [0.3.1](https://github.com/wardenenv/warden/tree/0.3.1) (2020-03-06)
[All Commits](https://github.com/wardenenv/warden/compare/0.3.0..0.3.1)
...
## Version [0.3.0](https://github.com/wardenenv/warden/tree/0.3.0) (2020-03-06)
[All Commits](https://github.com/wardenenv/warden/compare/0.2.4..0.3.0)

**Upgrade Notes:**

The fix for issue [#65](https://github.com/wardenenv/warden/issues/65) required removing the `warden` network from each environment's services (see commit [36cb0174](https://github.com/wardenenv/warden/commit/36cb0174399a40c7f3eb4c39ae70d33afd39c4a3)) and as a result environments referencing the `warden` network in per-project `.warden/*.yml` configuration files may need to be updated for compatibility with Warden 0.3.0.
...
To resolve this issue, simply remove the following from each service defined in `.warden/*.yml` files on the project similar to what was done in commit [36cb0174](https://github.com/wardenenv/warden/commit/36cb0174399a40c7f3eb4c39ae70d33afd39c4a3) on the base environment definitions:
...
* Updated to no longer connect environment containers to `warden` network and instead peer `traefik` and `tunnel` containers with each project when it is started (issue [#65](https://github.com/wardenenv/warden/issues/65))

**Enhancements:**

* Added automatic start of Mutagen sync on `env up` and `env start` when sync is not connected (issue [#90](https://github.com/wardenenv/warden/issues/90))
* Added automatic stop of Mutagen sync on `env down` and `env stop` (issue [#90](https://github.com/wardenenv/warden/issues/90))
* Updated routing rules so Traefik will now by default route both example.com and *.example.com to application ([#111](https://github.com/wardenenv/warden/pull/111) by [davidalger](https://github.com/davidalger))

## Version [0.2.4](https://github.com/wardenenv/warden/tree/0.2.4) (2020-02-29)
[All Commits](https://github.com/wardenenv/warden/compare/0.2.3..0.2.4)

**Bug Fixes:**

* Updated environment path (`WARDEN_ENV_PATH` in scripts) to use physical vs logical current working directory to resolve issues with using symlinked file paths (issue [#101](https://github.com/wardenenv/warden/issues/101))
* Removed confusingly quoted placeholder values related to Blackfire from env file generated by `env-init`
* Removed timeout for Selenium Hub, increased timeout for MFTF's `command.php` endpoint to 10 minutes ([#107](https://github.com/wardenenv/warden/pull/107) by [lbajsarowicz](https://github.com/lbajsarowicz))
* Fixed issue where `warden sync start` would infinitely wait when Mutagen encountered an error ([#100](https://github.com/wardenenv/warden/pull/100) by [Lunaetic](https://github.com/Lunaetic))

## Version [0.2.3](https://github.com/wardenenv/warden/tree/0.2.3) (2020-02-14)
[All Commits](https://github.com/wardenenv/warden/compare/0.2.2..0.2.3)

**Bug Fixes:**

* Fixed mutagen version check (issue [#95](https://github.com/wardenenv/warden/issues/95)); ([#94](https://github.com/wardenenv/warden/pull/94) by [blakesaunders](https://github.com/blakesaunders))

**Enhancements:**

* Added `explicit_defaults_for_timestamp=on` to `db` settings on `magento2` environment allowing `setup:db:status` to report clean (2.3.4 and later) (issue [#89](https://github.com/wardenenv/warden/issues/89))

## Version [0.2.2](https://github.com/wardenenv/warden/tree/0.2.2) (2020-02-09)
[All Commits](https://github.com/wardenenv/warden/compare/0.2.1..0.2.2)

**Enhancements:**

* Updated sign-certificates command to specify "O" value and "extendedKeyUsage" to comply with stricter SSL guidelines (issue [#85](https://github.com/wardenenv/warden/issues/85))

**Bug Fixes:**

* Fixed missing CN value on CA used to sign SSL certificates (issue [#85](https://github.com/wardenenv/warden/issues/85))

## Version [0.2.1](https://github.com/wardenenv/warden/tree/0.2.1) (2020-01-30)
[All Commits](https://github.com/wardenenv/warden/compare/0.2.0..0.2.1)
...
* Added support for using `~/.warden/.env` to configure aspects of Global Services ([see docs for details](https://docs.warden.dev/services.html)) (issue [#13](https://github.com/wardenenv/warden/issues/13))
...
## Version [0.2.0](https://github.com/wardenenv/warden/tree/0.2.0) (2020-01-27)
[All Commits](https://github.com/wardenenv/warden/compare/0.1.12..0.2.0)
...
Please reference the updated [base environment definitions](https://github.com/wardenenv/warden/tree/develop/environments) for examples of how to update the labels on custom definitions.
...
* Added `warden debug` command which launches user into Xdebug enabled `php-debug` container for debugging CLI based workflows (issue [#33](https://github.com/wardenenv/warden/issues/33); [#35](https://github.com/wardenenv/warden/pull/35) by [molotovbliss](https://github.com/molotovbliss))
* Added labels to `fpm` containers in `magento2` environment to support use of Live Reload via an injected JS snippet in the site header or footer (issue [#62](https://github.com/wardenenv/warden/issues/62))
* Added `WARDEN_ENV_NAME` as prefix to each container hostname in compose configs (issue [#29](https://github.com/wardenenv/warden/issues/29))
* Added `BYPASS_VARNISH` flag which when set in project `.env` file will cause Traefik to route requests directly to `nginx` container rather than `varnish` (issue [#63](https://github.com/wardenenv/warden/issues/63))
* Added `laravel` environment type to support local development of Laravel based applications (issue [#60](https://github.com/wardenenv/warden/issues/60))
* Added Allure reporting support to Selenium setup for MFTF ([#69](https://github.com/wardenenv/warden/pull/69) by [lbajsarowicz](https://github.com/lbajsarowicz))
...
* Updated configuration setup for SSH tunnel container so it will automatically re-instate the needed configuration (if missing) when running `up`, `start`, or `restart` to mitigate issue caused by macOS Catalina updates wiping out customizations to `/etc/ssh/ssh_config` (issue [#59](https://github.com/wardenenv/warden/issues/59))
* Updated `env-init` command to include default values for available variables in the project's `.env` making customization a bit easier (issue [#32](https://github.com/wardenenv/warden/issues/32))
* Updated default Elasticsearch version for `magento2` environments from 5.4 to 6.8 (issue [#66](https://github.com/wardenenv/warden/issues/66))
* Updated Selenium setup for MFTF to use hub and headless nodes by default (issue [#67](https://github.com/wardenenv/warden/issues/67); [#68](https://github.com/wardenenv/warden/pull/68) by [lbajsarowicz](https://github.com/lbajsarowicz))
* Updated environment templates to pass `TRAEFIK_DOMAIN` and `TRAEFIK_SUBDOMAIN` into `php-fpm` and `php-debug` for use in documented install routine (issue [#42](https://github.com/wardenenv/warden/issues/42))
* Updated default PHP version for `magento2` environments from 7.2 to 7.3 (issue [#75](https://github.com/wardenenv/warden/issues/75))
...
**Bug fixes:**
* Fixed broken incorrect Blackfire environment template name for magento1 env type (issue [#48](https://github.com/wardenenv/warden/issues/48))
* Fixed inability to get help content specific to env sub-commands using `warden env <command> -h`

## Version [0.1.12](https://github.com/wardenenv/warden/tree/0.1.12) (2019-12-10)
[All Commits](https://github.com/wardenenv/warden/compare/0.1.11..0.1.12)

**Bug fixes:**
* Fixed issue breaking SSH tunnel as used for port-forwards.

## Version [0.1.11](https://github.com/wardenenv/warden/tree/0.1.11) (2019-11-26)
[All Commits](https://github.com/wardenenv/warden/compare/0.1.10..0.1.11)

**Enhancements:**
* Added option to enable and setup Selenium for use with MFTF via flag in project's `.env` file ([#40](https://github.com/wardenenv/warden/pull/40) by [lbajsarowicz](https://github.com/lbajsarowicz))
* Added error message to `warden install` when `docker-compose` version in `$PATH` is incompatible ([#41](https://github.com/wardenenv/warden/pull/41) by [lbajsarowicz](https://github.com/lbajsarowicz))

## Version [0.1.10](https://github.com/wardenenv/warden/tree/0.1.10) (2019-09-23)

* Added native support to Warden for using the [split-database system](https://devdocs.magento.com/guides/v2.3/config-guide/multi-master/multi-master.html) in Magento Commerce during local development ([#5](https://github.com/wardenenv/warden/pull/5) by [navarr](https://github.com/navarr))
* Added support for optional Blackfire profiling which can be enabled via settings in the project's `.env` file ([#12](https://github.com/wardenenv/warden/pull/12) by [navarr](https://github.com/navarr))

## Version [0.1.9](https://github.com/wardenenv/warden/tree/0.1.9) (2019-09-19)
...
## Version [0.1.8](https://github.com/wardenenv/warden/tree/0.1.8) (2019-09-06)
...
## Version [0.1.7](https://github.com/wardenenv/warden/tree/0.1.7) (2019-08-23)
...
## Version [0.1.6](https://github.com/wardenenv/warden/tree/0.1.6) (2019-08-10)
...
## Version [0.1.5](https://github.com/wardenenv/warden/tree/0.1.5) (2019-07-19)
...
* Fixed issue causing `warden env` to break when run from a path which contained a space (issue [#3](https://github.com/wardenenv/warden/issues/3))

## Version [0.1.4](https://github.com/wardenenv/warden/tree/0.1.4) (2019-07-15)
...
## Version [0.1.3](https://github.com/wardenenv/warden/tree/0.1.3) (2019-07-10)
...
* Fixed issue with `bin/magento setup:install` allowing it to pass permissions checks ([#2](https://github.com/wardenenv/warden/pull/2) by [fooman](https://github.com/fooman))
* Fixed issue where `env` and `env-init` commands failed to reset shell colors when printing error messages (issue [#4](https://github.com/wardenenv/warden/issues/4))

## Version [0.1.2](https://github.com/wardenenv/warden/tree/0.1.2) (2019-07-03)
...
## Version [0.1.1](https://github.com/wardenenv/warden/tree/0.1.1) (2019-06-27)

* Fixed bug where 'db' commands broke due to template overhaul in 0.1.0 release.

## Version [0.1.0](https://github.com/wardenenv/warden/tree/0.1.0) (2019-06-27)
...
## Version [0.1.0-beta7](https://github.com/wardenenv/warden/tree/0.1.0-beta7)
...
## Version [0.1.0-beta6](https://github.com/wardenenv/warden/tree/0.1.0-beta6)
...
* Fixed bug where resolver setup on macOS would fail if `/etc/resolver` dir was already present during install ([#1](https://github.com/wardenenv/warden/pull/1) by [fooman](https://github.com/fooman))

## Version [0.1.0-beta5](https://github.com/wardenenv/warden/tree/0.1.0-beta5)
...
## Version [0.1.0-beta3](https://github.com/wardenenv/warden/tree/0.1.0-beta3)

* Fixed infinite loop on initial setup routine.

## Version [0.1.0-beta2](https://github.com/wardenenv/warden/tree/0.1.0-beta2)
...
## Version [0.1.0-beta1](https://github.com/wardenenv/warden/tree/0.1.0-beta1)
